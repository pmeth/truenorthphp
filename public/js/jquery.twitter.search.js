...
;(function($) {
	...
	$.fn.twitterSearch.defaults = {
		...
		animInSpeed: 1000,			// speed of scroll animation for moving tweets up
		...
		refreshSeconds: 180,          // number of seconds to wait before polling for newer tweets
		...
		css: {
			...
			container: { overflow: 'hidden', backgroundColor: '#fff', border: '1px solid #ddd', height: '460px', borderRadius: '4px', '-moz-border-radius': '4px', '-webkit-border-radius': '4px'  },
			...
			frame: { backgroundColor: '#f3f3f3', padding: '19px', border: '1px solid #ddd', borderRadius: '4px', '-moz-border-radius': '4px', '-webkit-border-radius': '4px' },
			tweet: { padding: '5px 10px', clear: 'left', borderBottom: '1px solid #ddd' },
