...
$speakers[] = array(
  ...
  'talks' => array(
      array(
          'title' => "Building A Developer Platform: From (o)Auth to Zen",
          "text" => "You've built an API to support your company's internal technical needs, and now you're thinking about opening it up either to the public or to a set of approved third-party partner developers. What's next? At NPR, we spent most of 2015 building a developer platform for our cloud-based listening app, NPR One, and the six key technical components that we've focused on are: authorization (using OAuth 2.0); documentation; permissioning; rate limiting; self-service console; and a versioning strategy. Come learn how we did it, including lessons learned, things that (often to our own amazement) worked out well, and a myriad of things that we wish we'd done differently, from an NPR developer. (And yes, we did it all in PHP!)
