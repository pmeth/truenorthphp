...
$speakers[] = array (
  ...
  'country' => 'Belgium',
  'twitter' => 'dragonbe',
  'image' => 'http://www.gravatar.com/avatar/194eb9f82dcaf56bcf47444a99f5f5b6?s=200&d=http://truenorthphp.ca/img/no-pic.jpg',
  'bio' => 'Michelangelo is a professional PHP consultant, community leader and president of PHPBenelux. You can find his articles on http://dragonbe.com or follow him on twitter.',
  'talks' => array (
    array (
      'title' => 'PHP Azure, a bright new day!',
      'text' => 'Windows Azure provides many services that are very appealing for PHP developers, especially if you need to get started quickly.
In this talk I give my motivation to try out Windows Azure cloud solutions, and discuss the main features like web sites, virtual machines and cloud services. Combining these features with blob storage, table storage, queues, WinCache, CDN and SSL you can build robust, scalable and very performant web applications and deploy them in just a few minutes.',
    ...
    array (
      'title' => 'Community Works for business too',
      'text' => 'Being part of the community is not just great to support the open-source movement, but it also is great for business.
